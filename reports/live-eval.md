...
Generated 2026-09-09T20:55:22+00:00. Window: flights departed in the last 7 days; per flight, the last prediction written before its actual departure. Matured predictions: **2800**.

Dates 2026-09-03..2026-09-10; observed P(delay > 15) = 0.1318; median lead time between last score and departure = 121.8 min.

| predictor | AUC | Brier | log loss | MAE (min) |
|---|---|---|---|---|
| model | 0.6835 | 0.1153 | 0.3805 | 10.974 |
| baseline_airline_hour | 0.6409 | 0.1349 | 0.4402 | 16.287 |
| naive_rate | 0.5 | 0.1144 | 0.3898 | 10.04 |

Coverage: **2800 of 2836** departures in the window (98.7%) carry a prediction written before they left; the rest were never scored in time and are excluded. They are not a random sample — a flight the cron misses is usually one that departed shortly after being scheduled — so the observed late rate above is the rate among *scored* flights, a little higher than the airport's.
...
|---|---:|---|---|
| auc | +0.0426 | [+0.0140, +0.0711] | **yes** |
| brier | -0.0196 | [-0.0232, -0.0160] | **yes** |
| logloss | -0.0597 | [-0.0694, -0.0495] | **yes** |
| mae | -5.31 | [-5.6258, -4.9932] | **yes** |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| 2026-09-03 † | 357 | 0.1625 | 0.6167 | 0.5567 | 0.1333 | 11.0 | 16.3 |
...
| 2026-09-10 *† | 37 | 0.1351 | 0.7375 | 0.8656 | 0.1007 | 7.9 | 11.5 |
...
|---|---:|---:|---:|---:|---:|
| after STD * | 82 | 0.6585 | 0.6286 | 0.4987 | 40.8 |
| < 30 min | 314 | 0.1306 | 0.6812 | 0.5851 | 9.3 |
| 30–120 min | 1043 | 0.1237 | 0.6762 | 0.6125 | 9.7 |
| 2–12 h | 1345 | 0.1078 | 0.6978 | 0.6960 | 10.6 |
| > 12 h * | 16 | 0.0000 | — | — | 6.5 |
...
|---|---:|---:|---:|
| 0.0-0.1 | 832 | 0.063 | 0.050 |
| 0.1-0.2 | 941 | 0.145 | 0.117 |
| 0.2-0.3 | 608 | 0.243 | 0.176 |
| 0.3-0.4 | 226 | 0.340 | 0.248 |
| 0.4-0.5 | 101 | 0.447 | 0.287 |
| 0.5-0.6 | 53 | 0.549 | 0.245 |
| 0.6-0.7 | 30 | 0.645 | 0.267 |
...
|---|---:|---:|---:|---:|---:|---|---|
| 4a4212f@2026-08-25T09:35:34+00:00 | 2800 | 0.6835 | 0.1153 | 0.3805 | 11.0 | 2026-09-02T17:31:01+00:00 | 2026-09-09T16:48:16+00:00 |
