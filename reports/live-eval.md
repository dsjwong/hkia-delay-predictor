...
Generated 2026-09-20T20:47:30+00:00. Window: flights departed in the last 7 days; per flight, the last prediction written before its actual departure. Matured predictions: **2839**.

Dates 2026-09-14..2026-09-21; observed P(delay > 15) = 0.1282; median lead time between last score and departure = 129.2 min.

| predictor | AUC | Brier | log loss | MAE (min) |
|---|---|---|---|---|
| model | 0.6811 | 0.1095 | 0.3679 | 11.188 |
| baseline_airline_hour | 0.6438 | 0.1343 | 0.4387 | 16.828 |
| naive_rate | 0.5 | 0.1118 | 0.383 | 11.027 |

Coverage: **2839 of 2878** departures in the window (98.6%) carry a prediction written before they left; the rest were never scored in time and are excluded. They are not a random sample — a flight the cron misses is usually one that departed shortly after being scheduled — so the observed late rate above is the rate among *scored* flights, a little higher than the airport's.

## Model minus airline × hour baseline

Paired bootstrap, 2,000 resamples over the 2839 matured flights.

| metric | delta | 95 % CI | separable from noise? |
|---|---:|---|---|
| auc | +0.0373 | [+0.0122, +0.0610] | **yes** |
| brier | -0.0248 | [-0.0281, -0.0211] | **yes** |
| logloss | -0.0708 | [-0.0802, -0.0606] | **yes** |
| mae | -5.64 | [-5.9544, -5.3123] | **yes** |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| 2026-09-14 † | 363 | 0.1708 | 0.6488 | 0.6161 | 0.1384 | 15.6 | 20.2 |
...
| 2026-09-21 *† | 37 | 0.2162 | 0.4612 | 0.5453 | 0.1899 | 12.8 | 13.7 |
...
|---|---:|---:|---:|---:|---:|
| after STD | 108 | 0.6667 | 0.5953 | 0.5841 | 49.5 |
| < 30 min | 302 | 0.1291 | 0.6798 | 0.5700 | 9.4 |
| 30–120 min | 1014 | 0.1114 | 0.6578 | 0.6247 | 9.9 |
| 2–12 h | 1402 | 0.0999 | 0.6707 | 0.6493 | 9.6 |
| > 12 h * | 13 | 0.0000 | — | — | 4.6 |
...
|---|---:|---:|---:|
| 0.0-0.1 | 829 | 0.062 | 0.053 |
| 0.1-0.2 | 1015 | 0.148 | 0.107 |
| 0.2-0.3 | 631 | 0.246 | 0.181 |
| 0.3-0.4 | 261 | 0.342 | 0.234 |
| 0.4-0.5 | 68 | 0.440 | 0.250 |
| 0.5-0.6 * | 26 | 0.553 | 0.538 |
| 0.6-0.7 * | 7 | 0.641 | 0.571 |
...
|---|---:|---:|---:|---:|---:|---|---|
| 4a4212f@2026-08-25T09:35:34+00:00 | 2839 | 0.6811 | 0.1095 | 0.3679 | 11.2 | 2026-09-13T16:31:21+00:00 | 2026-09-20T16:36:34+00:00 |
...
Model versions in window: {'4a4212f@2026-08-25T09:35:34+00:00': 2839}
